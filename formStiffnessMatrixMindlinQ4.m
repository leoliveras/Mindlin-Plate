...
[gaussWeights,gaussLocations]=getGaussQuadrature('complete');
...
[shape, naturalDerivatives] = getShapeFunction(xi,eta,'Q4');
% Jacobian matrix, inverse of Jacobian,
% derivatives w.r.t. x,y
[Jacob,invJacobian,XYderivatives]=getJacobian(nodeCoordinates(indice,:),naturalDerivatives);
...
[gaussWeights,gaussLocations]=getGaussQuadrature('reduced');
% cycle for element
% cycle for element
for e=1:numberElements
% indice : nodal condofectivities for each element
...
% shape functions and derivatives
[shapeFunction,naturalDerivatives]=getShapeFunction(xi,eta,'Q4');
% Jacobian matrix, inverse of Jacobian,
% derivatives w.r.t. x,y
[Jacob,invJacobian,XYderivatives]=getJacobian(nodeCoordinates(indice,:),naturalDerivatives);
% [B] matrix shear
